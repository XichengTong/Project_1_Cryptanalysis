...
mono_substitution_key_2 = "iop asdfghjklznmxcvbqwertyu"
poly_key="mykey"
...
if __name__ == "__main__":
    ...
    print("here is the mono part:")

    print("the simplest mono encrypt:")
    mono_cyphertext=mono_encrypt(plaintext_decided,mono_encryption_dict)
    print(mono_cyphertext)

    print("we also encrypt the space!")
    mono_cyphertext = mono_encrypt(plaintext_decided, mono_encryption_dict_2)
    print(mono_cyphertext)

    print("finally do a 10 percent random change:")
    randomized_mono_withspace = random_change_10_percent(mono_cyphertext)
    print(randomized_mono_withspace)

    print("here is the poly part:")

    print("the simplest poly encrypt:")
    ...
    print("finally do a 10 percent random change:")
    randomized_poly_withspace=random_change_10_percent(poly_cyphertext)
    print(randomized_poly_withspace)
